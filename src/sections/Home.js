  ...
  return (
    <div className="grid md:grid-cols-2 gap-8 items-center">
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="space-y-4">
        ...
        <p className="text-neutral-600 dark:text-neutral-400">Mock intro about you. Replace this with your real description.</p>
      ...
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="rounded-xl border p-6">
        <div className="aspect-[4/3] w-full grid place-content-center text-center bg-neutral-100 dark:bg-neutral-800 rounded-xl">
          <p className="text-neutral-600 dark:text-neutral-400">Photo or banner here</p>
        </div>
      </motion.div>
    </div>
  )
